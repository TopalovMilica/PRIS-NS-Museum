...
public class PeriodController {
	...
	public ResponseEntity<String> kreirajPeriod(@RequestBody Period period) {
		if (period.getNaziv() == null || String.valueOf(period.getPocetak_perioda()) == null || String.valueOf(period.getKraj_perioda()) == null) {
			return new ResponseEntity<>("Naziv, pocetak i kraj perioda su obavezni!", HttpStatus.BAD_REQUEST);
		}
		
		Optional<Period> postojeciPeriod = pr.findbyNazivPocetakKraj(period.getNaziv(), period.getPocetak_perioda(), period.getKraj_perioda());
